...
const entries = [
  ...
  },
  {
    ...
    bullets: [
      ...
      'Uploads via `after:run` event at the end of your Cypress suite',
      'Works with GitHub Actions, GitLab CI, CircleCI, and any other pipeline',
    ],
  },
  {
    date: '2026-05-11',
    version: 'SDK 1.0.1',
    title: 'Playwright Reporter 1.0.1 — Stable',
    category: 'New Feature',
    categoryColor: 'bg-sky-100 text-sky-700',
    description: '`@testably.kr/playwright-reporter@1.0.1` graduates to stable. Connect Playwright to Testably in one `npm install` and see CI results land in your dashboard automatically.',
    bullets: [
      'npm install --save-dev @testably.kr/playwright-reporter',
      'Tag tests with `[TC-101]` in the title — reporter auto-matches test cases',
      'Auto-uploads on `onEnd` after `playwright test` completes',
  ...
  },
  {
    ...
    bullets: [
      'npm install @testably.kr/playwright-reporter (or cypress variant)',
      'Playwright and Cypress reporters available today',
