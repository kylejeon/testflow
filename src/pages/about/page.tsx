    ...
    <>
      ...
      <div className="min-h-screen bg-white" style={{ fontFamily: '"Inter", "Noto Sans KR", sans-serif' }}>
        ...
        <header className="py-24 bg-gray-950 text-center relative overflow-hidden">
          <div className="absolute -top-32 left-1/2 -translate-x-1/2 w-[700px] h-[700px] rounded-full bg-teal-500/10 blur-[140px]"></div>
          <div className="relative z-10 max-w-3xl mx-auto px-6">
            <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-4 py-1.5 mb-6">
              <i className="ri-information-line text-teal-300 text-sm"></i>
              <span className="text-teal-200 text-sm font-medium">About Us</span>
            </div>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-3xl mx-auto px-6 text-center">
            <div className="inline-flex items-center gap-2 bg-teal-50 border border-teal-100 rounded-full px-4 py-1.5 mb-6">
              <i className="ri-focus-3-line text-teal-600 text-sm"></i>
              <span className="text-teal-700 text-sm font-medium">Our Mission</span>
            </div>
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-14">
              <div className="inline-flex items-center gap-2 bg-teal-50 border border-teal-100 rounded-full px-4 py-1.5 mb-4">
                ...
                <span className="text-teal-700 text-sm font-medium">What Makes Us Different</span>
              </div>
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900">Built different, on purpose</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {differentiators.map((d) => (
                <article key={d.title} className="bg-white rounded-2xl p-7 border border-gray-100 hover:border-teal-200 hover:shadow-md transition-all">
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-14">
              <div className="inline-flex items-center gap-2 bg-teal-50 border border-teal-100 rounded-full px-4 py-1.5 mb-4">
                ...
                <span className="text-teal-700 text-sm font-medium">Our Values</span>
              </div>
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900">What we believe</h2>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {values.map((v) => (
                <article key={v.title} className="bg-gray-50 rounded-2xl p-6 border border-gray-100 hover:border-teal-200 hover:shadow-md transition-all text-center">
                  <div className="w-11 h-11 bg-teal-100 rounded-xl flex items-center justify-center mb-4 mx-auto">
                    <i className={`${v.icon} text-teal-600 text-xl`}></i>
                  </div>
          ...
          <div className="max-w-2xl mx-auto px-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                ...
                className="px-8 py-3.5 bg-white text-teal-600 rounded-xl font-bold hover:bg-gray-50 transition-all cursor-pointer inline-flex items-center gap-2 justify-center"
              >
