  ...
  const handleExportPDF = async () => {
    try {
      ...
      const addFooter = (pageNum: number) => {
        pdf.setFontSize(8); pdf.setFont('NotoSansKR', 'normal'); pdf.setTextColor(148, 163, 184);
      ...
      pdf.setFontSize(18); pdf.setTextColor(255, 255, 255); pdf.setFont('NotoSansKR', 'bold');
      pdf.text(projectName, margin, 14);
      pdf.setFontSize(10); pdf.setFont('NotoSansKR', 'normal');
      ...
      stats.forEach((s, i) => {
        ...
        pdf.setFontSize(16); pdf.setFont('NotoSansKR', 'bold'); pdf.setTextColor(15, 23, 42);
        pdf.text(s.value, x + cardW / 2, y + 12, { align: 'center' });
        pdf.setFontSize(8); pdf.setFont('NotoSansKR', 'normal'); pdf.setTextColor(100, 116, 139);
      ...
      Object.entries(lifecycleCounts).forEach(([lc, count], i) => {
        ...
        pdf.setFontSize(14); pdf.setFont('NotoSansKR', 'bold'); pdf.setTextColor(15, 23, 42);
