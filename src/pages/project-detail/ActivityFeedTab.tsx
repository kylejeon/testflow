        ...
        <div className="space-y-0">
          {Array.from({ length: 8 }).map((_, i) => (
            <div key={i} className="flex gap-3 px-4 py-3 border-b border-gray-100">
              <div className="w-8 h-8 rounded-full animate-pulse-bright flex-shrink-0" />
              <div className="flex-1 space-y-2 pt-1">
                <div className="h-3 animate-pulse-bright rounded w-3/4" />
                <div className="h-2.5 animate-pulse-bright rounded w-1/3" />
              </div>
            </div>
          ))}
        </div>
