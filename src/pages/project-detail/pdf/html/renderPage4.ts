...
<div class="pdf-content">
  ...
  <div style="background:rgb(248,250,252);border:1px solid rgb(226,232,240);border-radius:8px;padding:10px 18px;margin-bottom:14px;">
    <table style="width:100%;table-layout:fixed;border-collapse:collapse;">
      <tr>
        ${runSummary.map((s, i) => `
        ${i > 0 ? '<td style="width:1px;vertical-align:middle;"><span style="border-left:1px solid rgb(226,232,240);height:32px;display:inline-block;vertical-align:middle;"></span></td>' : ''}
