...
export function renderPage8(
  ...
  <div style="background:rgb(248,250,252);border:1px solid rgb(226,232,240);border-radius:8px;padding:8px 14px;margin-bottom:14px;">
    <table style="width:100%;table-layout:fixed;border-collapse:collapse;">
      <tr>
        <td style="text-align:center;vertical-align:middle;padding:4px;">
          <span style="width:10px;height:10px;border-radius:50%;background:rgb(16,163,127);display:inline-block;vertical-align:middle;margin-right:6px;"></span>
          <span style="font-size:10px;color:rgb(100,116,139);vertical-align:middle;">Active: <strong style="color:rgb(15,23,42);">${lifecycleCounts.active} (${data.testCases.length > 0 ? (lifecycleCounts.active / data.testCases.length * 100).toFixed(1) : 0}%)</strong></span>
        </td>
        <td style="width:1px;vertical-align:middle;">
          <span style="border-left:1px solid rgb(226,232,240);height:28px;display:inline-block;vertical-align:middle;"></span>
        </td>
        <td style="text-align:center;vertical-align:middle;padding:4px;">
          <span style="width:10px;height:10px;border-radius:50%;background:rgb(139,92,246);display:inline-block;vertical-align:middle;margin-right:6px;"></span>
          <span style="font-size:10px;color:rgb(100,116,139);vertical-align:middle;">Draft: <strong style="color:rgb(15,23,42);">${lifecycleCounts.draft} (${data.testCases.length > 0 ? (lifecycleCounts.draft / data.testCases.length * 100).toFixed(1) : 0}%)</strong></span>
        </td>
        <td style="width:1px;vertical-align:middle;">
          <span style="border-left:1px solid rgb(226,232,240);height:28px;display:inline-block;vertical-align:middle;"></span>
        </td>
        <td style="text-align:center;vertical-align:middle;padding:4px;">
          <span style="width:10px;height:10px;border-radius:50%;background:rgb(203,213,225);display:inline-block;vertical-align:middle;margin-right:6px;"></span>
          <span style="font-size:10px;color:rgb(100,116,139);vertical-align:middle;">Deprecated: <strong style="color:rgb(15,23,42);">${lifecycleCounts.deprecated} (${data.testCases.length > 0 ? (lifecycleCounts.deprecated / data.testCases.length * 100).toFixed(1) : 0}%)</strong></span>
        </td>
      </tr>
    </table>
  </div>
