  ...
  en: {
    ...
    features: [
      ...
      },
      {
        ...
        description: 'Connect Playwright, Cypress, and Jest to Testably in one command: npm install @testably.kr/playwright-reporter. Results flow into your runs automatically — no manual uploads, no config headaches. Fully compatible with the existing CI/CD API.',
        color: 'bg-sky-50',
  ...
  ko: {
    ...
    features: [
      ...
      },
      {
        icon: 'ri-terminal-box-line',
        title: '자동화 테스트 SDK',
        description: 'npm install @testably.kr/playwright-reporter 한 줄로 Playwright, Cypress, Jest를 연결하세요. 결과가 자동으로 Run에 반영되며 기존 CI/CD API와 완전히 호환됩니다.',
        color: 'bg-sky-50',
        iconColor: 'text-sky-600',
        tag: 'SDK',
      },
