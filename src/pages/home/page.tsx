  ...
  en: {
    ...
    pricingPlans: [
      ...
      },
      {
        ...
        features: ['Up to 10 projects', 'TC Versioning', 'Export/Import CSV', 'Jira integration', 'Slack & Teams integration', 'Basic reporting', '30 AI generations / month', 'AI Run Summary', 'Flaky Detection AI', 'Coverage Gap Analysis', 'Suggest Edge Cases (AI)', 'AI Insights Panel', 'Email support', 'Export PDF Report'],
      ...
      },
      {
        ...
        features: ['Unlimited projects', 'TC Versioning', 'Export/Import CSV', 'Jira integration', 'Slack & Teams integration', 'Advanced reporting', 'CI/CD Integration', 'Test Automation Framework SDK', '150 AI generations / month', 'AI Run Summary', 'Flaky Detection AI', 'Coverage Gap Analysis', 'Suggest Edge Cases (AI)', 'AI Insights Panel', 'Priority support', 'Export PDF Report'],
  ...
  ko: {
    ...
    pricingPlans: [
      ...
      },
      {
        ...
        features: ['프로젝트 10개까지', 'TC 버전 관리', 'CSV 내보내기/가져오기', 'Jira 연동', 'Slack & Teams 연동', '기본 리포팅', 'AI 생성 30회/월', 'AI 실행 요약', '플레이키 테스트 감지 AI', '커버리지 갭 분석', '엣지 케이스 제안 (AI)', 'AI 인사이트 패널', '이메일 지원', 'PDF 리포트 내보내기'],
      ...
      },
      {
        ...
        features: ['프로젝트 무제한', 'TC 버전 관리', 'CSV 내보내기/가져오기', 'Jira 연동', 'Slack & Teams 연동', '고급 리포팅', 'CI/CD 연동', '테스트 자동화 Framework SDK', 'AI 생성 150회/월', 'AI 실행 요약', '플레이키 테스트 감지 AI', '커버리지 갭 분석', '엣지 케이스 제안 (AI)', 'AI 인사이트 패널', '우선 지원', 'PDF 리포트 내보내기'],
