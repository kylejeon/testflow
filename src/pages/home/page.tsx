  ...
  en: {
    ...
    pricingPlans: [
      ...
      },
      {
        ...
        features: ['Up to 10 projects', 'Up to 8 members', 'Jira integration', 'Basic reporting', 'Email support'],
      ...
      },
      {
        ...
        features: ['Unlimited projects', 'Up to 15 members', 'Jira integration', 'Advanced reporting', 'CI/CD Integration', 'Priority support'],
        cta: 'Start Free Trial',
        highlighted: true,
  ...
  ko: {
    ...
    pricingPlans: [
      ...
      },
      {
        ...
        features: ['프로젝트 무제한', '팀 멤버 15명까지', 'Jira 연동', '고급 리포팅', 'CI/CD 연동', '우선 지원'],
        cta: '14일 무료 체험',
        highlighted: true,
        icon: 'ri-vip-crown-line',
        popular: '가장 인기',
