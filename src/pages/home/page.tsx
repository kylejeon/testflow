  ...
  en: {
    ...
    features: [
      ...
      },
      {
        ...
        description: 'Connect Playwright and Cypress to Testably in one command: npm install @testably.kr/playwright-reporter (or cypress variant). Results flow into your runs automatically — no manual uploads, no config headaches. Jest coming soon.',
        color: 'bg-sky-50',
  ...
  ko: {
    ...
    features: [
      ...
      },
      {
        icon: 'ri-terminal-box-line',
        title: '자동화 테스트 SDK',
        description: 'npm install @testably.kr/playwright-reporter (또는 cypress 변형) 한 줄로 Playwright, Cypress를 연결하세요. 결과가 자동으로 Run에 반영되며 기존 CI/CD API와 완전히 호환됩니다. Jest는 곧 지원됩니다.',
        color: 'bg-sky-50',
        iconColor: 'text-sky-600',
        tag: 'SDK',
      },
    ...
    pricingPlans: [
      ...
      },
      {
        ...
        basePlan: 'Starter',
        features: ['프로젝트 무제한 · 멤버 20명', 'RTM: 감사 추적 + AI 커버리지 갭', '공유 스텝 무제한', 'CI/CD 연동', '테스트 자동화 SDK (Playwright & Cypress)', '고급 리포팅 · 우선 지원', 'AI 생성 150회/월'],
