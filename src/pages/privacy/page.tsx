        ...
        <footer className="bg-gray-100 py-8 mt-16 border-t border-gray-200">
          <div className="max-w-3xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <nav className="flex items-center gap-4 text-xs text-gray-500">
              <button onClick={() => navigate('/privacy')} className="hover:text-gray-900 transition-colors cursor-pointer font-semibold text-indigo-600">{t.privacy}</button>
              <span className="text-gray-300">|</span>
              <button onClick={() => navigate('/terms')} className="hover:text-gray-900 transition-colors cursor-pointer">{t.terms}</button>
            </nav>
          </div>
        </footer>
      </div>
