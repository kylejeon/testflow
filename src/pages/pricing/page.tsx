...
const plans = [
  ...
  },
  {
    ...
    features: [
      ...
      'CI/CD Integration',
      'Test Automation SDK (Playwright & Cypress)',
      'Advanced reporting',
      'Priority support',
...
const comparisonRows = [
  ...
  { feature: 'AI Run Summary', free: false, hobby: true, starter: true, pro: true, entS: true, entM: true, entL: true },
  ...
  { feature: 'AI Insights Panel', free: true, hobby: true, starter: true, pro: true, entS: true, entM: true, entL: true },
  { feature: 'CI/CD integration', free: false, hobby: false, starter: false, pro: true, entS: true, entM: true, entL: true },
  { feature: 'Test Automation SDK (Playwright & Cypress)', free: false, hobby: false, starter: false, pro: true, entS: true, entM: true, entL: true },
