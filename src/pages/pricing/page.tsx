...
const enterpriseTiers = [
  {
    ...
    features: [
      ...
      'Suggest Edge Cases (AI)',
      'AI Insights Panel',
      'RTM (Unlimited + Audit Trail + Jira sync)',
      'Shared Steps (Unlimited + Full version history)',
      'Test Automation Framework SDK',
      'Advanced reporting',
      'CI/CD Integration',
      'Dedicated support',
...
const comparisonRows = [
  ...
  { feature: 'Shared Steps', free: false, starter: '20 steps', pro: 'Unlimited', entS: 'Full history', entM: 'Full history', entL: 'Full history' },
